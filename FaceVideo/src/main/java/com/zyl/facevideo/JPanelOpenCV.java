...
public class JPanelOpenCV extends JPanel {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -8380587628566763361L;
	BufferedImage image;
    ...
    public static void main (String args[]) throws InterruptedException{
        ...
        CascadeClassifier faceDetector = new CascadeClassifier(JPanelOpenCV.class.getResource("/lbpcascade_frontalface.xml").getPath());
